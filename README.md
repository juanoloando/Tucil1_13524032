# Penyelesaian Permainan Queens Menggunakan Algoritma Brute Force
---

## Penjelasan Singkat Tentang Program

**Queens** adalah suatu gim logika yang tersedia pada situs LinkedIn. Ada beberapa aturan dari permainan ini.

Diberikan grid *N* x *N* dimana setiap sel memiliki warna (direpresentasikan sebagai huruf A-Z). Misinya adalah menempatkan *N* Queens dengan aturan:
1. Satu Queen per baris
2. Satu Queen per kolom
...
Untuk menjalankan program, cukup lakukan dua langkah berikut.
1. klik tombol "**Insert File Test Case (.txt)**" 
2. Pilih file .txt yang berisi test case, lalu klik "**Generate Solution**"
3. Jika ingin menyimpan solusi, maka dapat klik tombol "**Save as Image**" dan/atau "**Save as .txt**". File output akan disimpan pada folder "**test/**"
